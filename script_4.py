# Continue with the remaining SCSS styles
scss_part2 = '''
...
# Append the second part to the SCSS file
project_files['assets/css/main.scss'] += scss_part2

print("Complete SCSS styles added successfully!")